...
output = df['Bladder type disorder']
...
df['Bladder type disorder'] = output_encoded

# Preprocess the dataset
X = df.drop('Bladder type disorder', axis=1)
y = df['Bladder type disorder']

# Define the target variable and features
target = 'Bladder type disorder'
